...
function printComplexity(sortingMethod) {
    ...
    else if(sortingMethod == 'quick_sort'){
        TCcontainer.innerHTML = 'Worst Case: O(n^2) <br>Average Case: &Theta;(nlog(n)) <br>Best Case: &Omega;(nlog(n))'; 
        SCcontainer.innerHTML = 'O(log(n))';
    }
